...
export default function LayananPage() {
  ...
  const isVisible = (catId, textContent = '') => {
    const tabMatch = activeTab === 'all' || activeTab === catId;
    if (!tabMatch) return false;
    if (!searchQuery.trim()) return true;
    return textContent.toLowerCase().includes(searchQuery.toLowerCase().trim());
  };
    ...
    <div className="w-full bg-[#F8FAF9]">
      ...
      <section className="border-b border-[#D1DDD4] bg-[#F8FAF9]">
        <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="px-4 py-3 rounded-xl border border-[#D1DDD4] shadow-sm flex items-center gap-3 shrink-0 self-start md:self-auto bg-white">
            <div className="h-10 w-10 rounded-full bg-[#EBF4EE] text-[#143826] flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-6 border-t border-[#D1DDD4]/70">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 py-4">
            <div className="flex items-center gap-2 overflow-x-auto pb-1 lg:pb-0 no-scrollbar">
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full font-label text-xs tracking-wide transition-all whitespace-nowrap ${
                    activeTab === cat.id
            ...
            <div className="relative w-full lg:w-80">
              <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#4F6056] text-lg">
                search
              </span>
              <input
                type="text"
                ...
                placeholder="Cari layanan (Vibram, Spa, Roda, Sol...)"
                className="w-full pl-9 pr-4 py-2 rounded-full text-xs font-body bg-white border border-[#D1DDD4] focus:border-[#143826] focus:ring-1 focus:ring-[#143826] focus:outline-none placeholder:text-[#4F6056]/60 shadow-sm"
              />
              {searchQuery && (
                <button
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-16">
        ...
        {(activeTab === 'all' || activeTab === 'shoes') && (
          <section className="space-y-8" id="cat-shoes">
            <div className="flex flex-col sm:flex-row sm:items-baseline justify-between border-b-2 border-[#143826] pb-3 gap-2">
              <div>
                <span className="font-label text-xs uppercase tracking-widest text-[#2E5C43] font-bold">
            ...
            {isVisible('shoes', 'Vibram Sole Recrafting Christy Morflex Ripple Commando Outsole') && (
              <div className="bg-white border border-[#D1DDD4] rounded-2xl p-6 lg:p-8 shadow-sm">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                  <div className="lg:col-span-5 space-y-3">
                    <div className="relative h-64 sm:h-72 rounded-xl overflow-hidden border border-[#D1DDD4]">
                      <img
                        src={vibramHeroImg}
                  ...
                  <div className="lg:col-span-7 space-y-4">
                    ...
                    <h3 className="font-headline text-2xl font-bold text-[#143826] uppercase">
                      Custom Vibram Sole Recrafting (Italian Outsole)
                    </h3>
                    <p className="text-sm text-[#4F6056] font-body leading-relaxed">
            ...
            <div className="bg-white border border-[#D1DDD4] rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
              ...
              <div className="divide-y divide-[#D1DDD4]/80">
                ...
                {isVisible('shoes', 'Surface Cleaning Express touch up cepat kotoran luar') && (
                ...
                {isVisible('shoes', 'Ultimate Cleaning Regular deep clean menyeluruh canvas kulit pelepasan tali midsole outsole') && (
                  <div className="py-4 sm:py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 group bg-[#F4F8F5]/80 -mx-4 px-4 rounded-xl">
                    <div className="space-y-1 max-w-xl">
                      <div className="flex items-center gap-3">
                        <span className="font-headline font-bold text-[#143826] text-base group-hover:text-[#C2101C] transition-colors">
                          Ultimate Cleaning Regular
                      ...
                      <p className="text-xs text-[#4F6056] font-body">
                        Deep clean menyeluruh: upper canvas/kulit, pelepasan tali, midsole, outsole, dan pemberian pelembab alami.
                      </p>
                    </div>
                    <div className="flex items-center justify-between sm:justify-end gap-5 shrink-0">
                ...
                {isVisible('shoes', 'Ultimate Cleaning Hard Condition penanganan kerak tanah oli banjir') && (
                  <div className="py-4 sm:py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 group">
                    <div className="space-y-1 max-w-xl">
                      <div className="flex items-center gap-3">
                        <span className="font-headline font-bold text-[#143826] text-base group-hover:text-[#C2101C] transition-colors">
                ...
                {isVisible('shoes', 'Premium Clean Insole Extraction keringat insole suede sterilisasi') && (
                  <div className="py-4 sm:py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 group">
                    <div className="space-y-1 max-w-xl">
                      <div className="flex items-center gap-3">
                        <span className="font-headline font-bold text-[#143826] text-base group-hover:text-[#C2101C] transition-colors">
                ...
                {isVisible('shoes', 'Sneaker Detox Ozone Chamber dekontaminasi bau spora jamur anti bakterial') && (
                  <div className="py-4 sm:py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 group">
                    <div className="space-y-1 max-w-xl">
                      <div className="flex items-center gap-3">
                        <span className="font-headline font-bold text-[#143826] text-base group-hover:text-[#C2101C] transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Unyellowing */}
              {isVisible('shoes', 'Whitening Unyellowing UV Chamber oksidasi sol karet hidrogen') && (
              ...
              {isVisible('shoes', 'Repaint Canvas Suede Leather pigmen warna anti cracking') && (
                <div className="bg-white border border-[#D1DDD4] rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:border-[#2E5C43] transition">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
              ...
              {/* Jahit Sol Manual */}
              {isVisible('shoes', 'Stitching Jahit Sol Tangan Wax Thread 60D kuncian benang') && (
                <div className="bg-white border border-[#D1DDD4] rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:border-[#2E5C43] transition">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
        ...
        {(activeTab === 'all' || activeTab === 'bags') && (
          <section className="space-y-8" id="cat-bags">
            <div className="flex flex-col sm:flex-row sm:items-baseline justify-between border-b-2 border-[#143826] pb-3 gap-2">
              <div>
                <span className="font-label text-xs uppercase tracking-widest text-[#2E5C43] font-bold">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              {isVisible('bags', 'Luxury Leather Bag Spa Patina Lambskin Box Calf Epsom Clemence Vachetta') && (
                <div className="lg:col-span-5 bg-white border border-[#D1DDD4] rounded-2xl p-6 sm:p-8 flex flex-col justify-between shadow-sm">
              ...
              <div className="lg:col-span-7 space-y-4">
                {/* Bag Cleaning Fabric */}
                {isVisible('bags', 'Bag Cleaning Canvas Nylon Jacquard Longchamp Tote') && (
                  <div className="bg-white border border-[#D1DDD4] rounded-2xl p-5 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                {/* Bag Detox */}
                {isVisible('bags', 'Bag De-Odor Sterilization Chamber bau asap jamur saku kain') && (
                  <div className="bg-white border border-[#D1DDD4] rounded-2xl p-5 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-start gap-4">
                ...
                {/* Zipper Replacement */}
                {isVisible('bags', 'Zipper Brass Puller Replacement YKK Excella original ritsleting macet') && (
                  <div className="bg-white border border-[#D1DDD4] rounded-2xl p-5 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-start gap-4">
                ...
                {/* Lining & Re-piping */}
                {isVisible('bags', 'Furing Interior Re-Piping Sudut ganti furing rontok tulang sudut tas') && (
                  <div className="bg-white border border-[#D1DDD4] rounded-2xl p-5 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-start gap-4">
                      <div className="h-10 w-10 rounded-xl bg-[#F4F8F5] border border-[#D1DDD4] flex items-center justify-center text-[#143826] shrink-0">
        ...
        {(activeTab === 'all' || activeTab === 'luggage') && (
          <section className="space-y-8" id="cat-luggage">
            <div className="flex flex-col sm:flex-row sm:items-baseline justify-between border-b-2 border-[#143826] pb-3 gap-2">
              <div>
                <span className="font-label text-xs uppercase tracking-widest text-[#2E5C43] font-bold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* Wheel Card */}
              {isVisible('luggage', 'Roda Koper Rubber Bearing Silent Spinner double wheel putaran hening') && (
              ...
              {/* Trolley Handle Card */}
              {isVisible('luggage', 'Trolley Gagang Tarikan Telescopic pipa aluminium bengkok handling bagasi') && (
                <div className="bg-white border border-[#D1DDD4] rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:border-[#143826] transition">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
              ...
              {/* TSA Lock Card */}
              {isVisible('luggage', 'Kunci TSA 007 Replacement kombinasi nomor standar petugas bandara') && (
                <div className="bg-white border border-[#D1DDD4] rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:border-[#143826] transition">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
              ...
              {/* Body Crack / Dent */}
              {isVisible('luggage', 'Body Crack Dent Restorasi retak bodi polycarbonate serat resin komposit aluminium') && (
                <div className="bg-white border border-[#D1DDD4] rounded-2xl p-6 shadow-sm flex flex-col justify-between hover:border-[#143826] transition">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
        ...
        {(activeTab === 'all' || activeTab === 'leather') && (
          <section className="space-y-8" id="cat-leather">
            <div className="flex flex-col sm:flex-row sm:items-baseline justify-between border-b-2 border-[#143826] pb-3 gap-2">
              <div>
                <span className="font-label text-xs uppercase tracking-widest text-[#2E5C43] font-bold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Jacket Spa */}
              {isVisible('leather', 'Leather Jacket Conditioning Spa pembersihan jalanan motor mink oil lentur') && (
              ...
              {/* Belt Edge Paint */}
              {isVisible('leather', 'Leather Belt Edge Paint Polish pelapisan karet edge kote buckle sabuk') && (
                <div className="bg-white border border-[#D1DDD4] rounded-2xl p-6 shadow-sm flex flex-col justify-between">
                  <div className="space-y-3">
              ...
              {/* Wallet Spa */}
              {isVisible('leather', 'Luxury Wallet Spa Sealing dompet lipat hidrasi kaku tepi dompet') && (
                <div className="bg-white border border-[#D1DDD4] rounded-2xl p-6 shadow-sm flex flex-col justify-between">
                  <div className="space-y-3">
        ...
        {(activeTab === 'all' || activeTab === 'packages') && (
          <section className="space-y-8" id="cat-packages">
            <div className="bg-[#07130C] border border-white/10 text-white rounded-3xl p-8 sm:p-12 shadow-xl relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-8">
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-white/15 pb-6">
                  <div>
                    ...
                    <h2 className="font-headline text-2xl sm:text-4xl font-bold text-white mt-1 uppercase">
        ...
        {/* ========================================================== */}
        <section className="bg-white border border-[#D1DDD4] rounded-3xl p-8 sm:p-10 shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7 space-y-4">
            ...
            <div className="lg:col-span-5 bg-[#F4F8F5] rounded-2xl p-6 border border-[#D1DDD4] space-y-3 text-xs font-body">
